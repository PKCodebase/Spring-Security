package com.nic.master.responseDTO.processServiceResponse;

import lombok.Data;

@Data
public class ProcessServiceResponse {
    ...
    public String getProcessDefGuid() { return processDefGuid; }
    public void setProcessDefGuid(String processDefGuid) { this.processDefGuid = processDefGuid; }
